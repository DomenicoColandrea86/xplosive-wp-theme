...
<?php
	...
	$ci_defaults['social_picasa_show'] 		= '';
	$ci_defaults['social_picasa_url'] 		= '';
	$ci_defaults['social_picasa_text']		= __('Follow me on SoundCloud', 'ci_theme');
		...
		<?php foreach($services as $key => $value): ?>
			...
			<fieldset class="social-set">
				<fieldset>					
					...
					<label for="<?php echo $field_show; ?>"><?php echo sprintf(__('Enable %s icon','ci_theme'), $value); ?></label>	
				</fieldset>
				<fieldset>
					<label for="<?php echo esc_attr($field_url); ?>"><?php echo sprintf(__('%s URL','ci_theme'), $value); ?></label>
				...
				<fieldset>
					<label for="<?php echo esc_attr($field_text); ?>"><?php echo sprintf(__('%s Text','ci_theme'), $value); ?></label>
