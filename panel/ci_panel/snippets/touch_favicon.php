...
<?php
	...
	$ci_defaults['touch_favicon']			= get_template_directory_uri().'/panel/ci_panel/img/apple-touch-icon.png';
	$ci_defaults['touch_favicon_pre']		= 'disabled';
	$ci_defaults['touch_favicon_72']		= get_template_directory_uri().'/panel/ci_panel/img/apple-touch-icon-72x72.png';
	$ci_defaults['touch_favicon_72_pre']	= 'disabled';
	$ci_defaults['touch_favicon_114']		= get_template_directory_uri().'/panel/ci_panel/img/apple-touch-icon-114x114.png';
