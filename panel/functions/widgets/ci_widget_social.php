...
class CI_Social extends WP_Widget {
	...
	function form($instance){
		...
		echo "<p>".__('This widget is a placeholder for Social Media icons. You may configure those icons from the CSSIgniter\'s panel, under the <strong>Social Options</strong> tab.', 'ci_theme')."</p>";
