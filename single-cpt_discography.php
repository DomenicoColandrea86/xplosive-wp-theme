		...
		<article <?php post_class('album group'); ?>>
			...
			<div class="four columns alpha album-cover">
				<div id="latest-album" class="latest-item">
					...
					?>
					<a href="<? echo $large_url[0]; ?>" data-rel="prettyPhoto">
					<?php
			...
			<div class="twelve columns content omega">
				...
				<div id="meta-wrap" class="group">
					<ul class="album-meta eight columns alpha">
						<?php if ($album_date != ""): ?><li><span><?php _e('Release date:','xplosive'); ?></span> <?php echo $album_date; ?></li><?php endif; ?>
						<?php if ($album_label != ""): ?><li><span><?php _e('Label:','xplosive'); ?></span> <?php echo $album_label; ?></li><?php endif; ?>
						<?php if ($album_cat_no != ""): ?><li><span><?php _e('Catalog #:','xplosive'); ?></span> <?php echo $album_cat_no; ?></li><?php endif; ?>
					</ul>
				</div><!-- /meta-wrap -->
