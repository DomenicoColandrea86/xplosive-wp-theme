	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<div id="comment-<?php comment_ID(); ?>" class="comment-text group">
			...
			<div class="comment-copy">
				...
				<?php if ( $comment->comment_approved == '0' ) : ?>
					<p><em><?php _e( 'Your comment is awaiting moderation.', 'xplosive' ); ?></em></p>
				<?php endif; ?>
		...
		?>
			<li class="post pingback">
				<p><?php _e( 'Pingback:', 'xplosive' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( __('(Edit)', 'xplosive'), ' ' ); ?></p>
			<?php break; ?>
	<?php endswitch; ?>
<?php
