...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'xplosive');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'xplosive');
...
if(!defined('CI_THEME_UPDATES')) 	define('CI_THEME_UPDATES', false);
